...
This code is provided as-is, there is little verification beyond a technical process of "looking out the window and seeing if what was on screen matched the sky", and next to no bounds or range checking, input verification or sanity checking.  You have been warned.
